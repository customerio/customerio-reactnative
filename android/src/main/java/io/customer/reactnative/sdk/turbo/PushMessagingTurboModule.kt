...
import io.customer.reactnative.sdk.messagingpush.PermissionStatus
import io.customer.reactnative.sdk.messagingpush.toFCMRemoteMessage
...
/**
 * TurboModule implementation for CustomerIO Push Messaging functionality
 */
class PushMessagingTurboModule(
    private val reactContext: ReactApplicationContext
) : TurboModule, PermissionListener, ActivityEventListener {

    override fun getName(): String = "PushMessagingModule"
    ...
    /**
     * Get the permission status constants
     */
    fun getPermissionStatus(): Map<String, String> {
        return mapOf(
            "Granted" to "GRANTED",
            "Denied" to "DENIED",
            "NotDetermined" to "NOTDETERMINED"
        )
    }

    /**
     * Get the push click behavior constants
     */
    fun getPushClickBehavior(): Map<String, String> {
        return mapOf(
            "ResetTaskStack" to "RESET_TASK_STACK",
            "ActivityPreventRestart" to "ACTIVITY_PREVENT_RESTART",
            "ActivityNoFlags" to "ACTIVITY_NO_FLAGS"
        )
    }
     ...
     */
    private val PermissionStatus.toReactNativeResult: String
