...
Pod::Spec.new do |spec|
  ...
  spec.version      = "2.10.1-modified" # Don't modify this line - it's automatically updated
  ...
  spec.source       = { :git => 'https://github.com/customerio/customerio-ios.git', :branch => 'master' }
